...
import ELint from '../assets/elint.svg';
import SEQ from '../assets/seq.svg';
    ...
    <div name='skills' className='w-full bg-[#0a192f] text-gray-300'>
      ...
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full'>
          ...
          <div className='w-full grid grid-cols-2 sm:grid-cols-4 gap-4 text-center py-8'>
              ...
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                  <img className='w-20 mx-auto' src={RTK} alt="HTML icon" />
                  <p className='my-4'>REDUX/RTK/RTK quary</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
              ...
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                  ...
                  <p className='my-4'>JIRA/CONFLUENCE</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                  <img className='w-20 mx-auto' src={JWT} alt="HTML icon" />
                  <p className='my-4'>JWT</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                  <img className='w-20 mx-auto' src={ELint} alt="HTML icon" />
                  <p className='my-4'>ESLint</p>
              </div>
              <div className='shadow-md shadow-[#040c16] hover:scale-110 duration-500'>
                  <img className='w-20 mx-auto' src={SEQ} alt="HTML icon" />
